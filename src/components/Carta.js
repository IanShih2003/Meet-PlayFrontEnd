...
function Card(props){
    ...
    return (
        ...
        <form className="cardstyle" action="">
          <img style={{marginLeft: 5, marginTop: 5,}} src={require('../user.png')} alt=""/>
          ...
          <p style={{color: 'gray', marginLeft: 120, fontSize: 27, marginTop: -40,}}>{name}</p>
          {/* <p style={{color: 'lightgray', marginLeft: 200, fontSize: 25, marginTop: -35,}}>21</p> */}
          <hr className="HR" style={{marginTop: 10}}/>
          <p style={{color: 'lightgray', marginLeft: 2}}>Hola! Soy nuevo en esta plataforma y me encantaria jugar contigo</p>
          <hr className="hrcard" style={{marginTop: 100,}}/>
          <p style={{color: 'lightgray', marginLeft: 2}}>Idiomas</p>
          <hr className="hrcard" style={{marginTop: 120}}/>
          <p style={{color: 'lightgray', marginLeft: 2}}>Juegos</p>
          <hr className="hrcard" style={{marginTop: 120}}/>
